...
#define HFAMP400_DEFAULT_VOLTAGE_SCALING ((60.0 / (float)0xFFF)) //correction factor determined empirically
...
#define ALERT_MASK_OPENDIODE ADV7294_ALERT_OPENDIODE
#define ALERT_MASK_OVERTEMP ADV7294_ALERT_OVERTEMP
